	...
	class Geocode
	{
		...
		function getGroupedSearches($aSearches, $aPhrases, $aValidTokens, $aWordFrequencyScores, $bStructuredPhrases)
		{
			...
			foreach($aPhrases as $iPhrase => $sPhrase)
			{
				...
				$sPhraseType = $aPhrases[$iPhrase]['type'];
		...
		*/
		function lookup()
		{
			...
			if ($sQuery || $this->aStructuredQuery)
			{
				...
				{
				    // For unstructured queries, phrases are a simple array (i.e. numerically indexed)
				...
				foreach($aPhrases as $iPhrase => $sPhrase)
				{
					...
					if (trim($aPhrase['string']))
					{
						...
						if ($bStructuredPhrases) $aPhrases[$iPhrase]['type'] = $iPhrase;
						else $aPhrases[$iPhrase]['type'] = '';
