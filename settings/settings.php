<?php
	...
	@define('CONST_Tokenizer_Languages', 'af|ar|br|ca|cs|de|en|es|et|eu|'
	...
	@define('CONST_Tokenizer_TagBlacklist', 'boundary=administrative,'
	                                       .'place=house|houses');
	// If a class is in the white list then all types will 
	// be ignored except the ones given in the list.
	// Also use this list to exclude an entire class from special phrases.
	@define('CONST_Tokenizer_TagWhitelist', 'highway=bus_stop|rest_area|raceway,'
	                                       .'building=');
